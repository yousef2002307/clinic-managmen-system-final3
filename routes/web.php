...
Route::get('/userdocpro/{id}', function ($id) {
   ...
   return view("users.doc",compact("doc"));
   }
...
Route::get('useredit/{id}', function ($id) {
    ...
    return view("users.appoi",compact("editid","appoiment"));
 })->middleware(HomeMw::class);
 ...
 Route::post('/userupd2', [UserController::class,"userupdate"])->middleware(HomeMw::class)->name("user-upd.post");
