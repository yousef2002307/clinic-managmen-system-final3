                         ...
                         <td class="status border-bottom-0"><span class="non-active">Non-paid</span></td>
                          ...
                          <td>
                              <button type="button" class="close" >
                                <a class="aclose" href="{{url('/docdelete/' . $item->id . '/' . $item->patients->id)}}"> <span aria-hidden="true"><i class="fa fa-close"></i></span></a>
                          </button>
                         
                        </td>
                        <td>
                          <a href="{{url('/viewinfo',$item->patients->id)}}" class="inf hvr-bounce-to-right theme_btn_two  ">view info</a>
                        </td>
                        </tr>  
                        @endforeach
                        <!--
